...
const BackgroundImg = () => {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Foreground */}
      <div className="relative z-10 flex flex-col items-center justify-center text-center h-screen w-full overflow-hidden px-2">
        <h1 className="font-maker text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-bold mb-4 text-white drop-shadow-lg">
          Tiffinity
        </h1>
        <p className="text-base sm:text-lg md:text-2xl text-orange-300 max-w-full">
          Delicious food delivered to your doorstep
        </p>
        <div className="pt-8">
          <button
            onClick={() => navigate("/order-now")}
            className="mt-4 px-6 py-3 text-lg sm:text-xl md:text-3xl font-extrabold text-green-400 
            border-2 border-white rounded-2xl cursor-pointer 
            shadow-[0_0_10px_rgba(34,197,94,0.7)] hover:shadow-[0_0_30px_rgba(34,197,94,1)] 
            transition-all duration-500 transform hover:scale-110 hover:text-white animate-pulse-fast"
          >
